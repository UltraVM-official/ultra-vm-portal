...
const PTERODACTYL_API_KEY = process.env.PTERODACTYL_API_KEY || 'ptla_fWEqJbMYXYhPVHSqXvFFCP9OlncLW6GaBfiZDPJdUrI';
const PTERODACTYL_PANEL_URL = process.env.PTERODACTYL_PANEL_URL || 'https://panel.ultravm.xyz';
